...
func TestLength(t *testing.T) {
	...
	tests := []struct {
		...
		{"t1", 2, 4, "abc", ""},
		{"t2", 2, 4, "", ""},
		{"t3", 2, 4, "abcdf", "length_between|2,4"},
		{"t4", 0, 4, "ab", ""},
		{"t5", 0, 4, "abcde", "length_more|4"},
		{"t6", 2, 0, "ab", ""},
		{"t7", 2, 0, "a", "length_less|2"},
		{"t8", 2, 0, v, ""},
...
func TestRuneLength(t *testing.T) {
	...
	tests := []struct {
		...
		{"t1.1", 2, 3, "💥💥", ""},
		{"t1.2", 2, 3, "💥💥💥", ""},
		{"t1.3", 2, 3, "💥", "length_between|2,3"},
		{"t1.4", 2, 3, "💥💥💥💥", "length_between|2,3"},
		{"t2", 2, 4, "", ""},
		{"t3", 2, 4, "abcdf", "length_between|2,4"},
		{"t4", 0, 4, "ab", ""},
		{"t5", 0, 4, "abcde", "length_more|4"},
		...
		{"t14", 2, 3, &sql.NullString{String: "💥", Valid: true}, "length_between|2,3"},
	}
...
func Test_LengthRule_Error(t *testing.T) {
	r := Length(10, 20)
	assert.Equal(t, "length_between|10,20", r.message)

	r = Length(0, 20)
	assert.Equal(t, "length_more|20", r.message)

	r = Length(10, 0)
	assert.Equal(t, "length_less|10", r.message)
